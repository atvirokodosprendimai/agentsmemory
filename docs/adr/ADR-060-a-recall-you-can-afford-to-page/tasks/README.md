...
|----|-------|--------|--------|------------|
| T1 | `am_search` returns a thin, truthful page when `ids_only` is true | done | — | `go test ./internal/mcptest/ -run 'TestAnIdsOnlyPageCarriesNoContentAndSaysSo$|TestAThinPageOverTheBudgetWithholdsNothing$' …` |
