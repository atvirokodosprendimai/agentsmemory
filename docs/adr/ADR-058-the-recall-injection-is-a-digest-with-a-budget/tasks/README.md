...
|----|-------|--------|--------|------------|
| T1 | `mcp search --digest <chars>` renders a bounded plain-text digest of the page | pending | — | `go test ./clients/claude-code/ -run 'TestTheDigestFitsItsBudget$|TestTheDigestIsSelectedByTheFlag$' …` |
