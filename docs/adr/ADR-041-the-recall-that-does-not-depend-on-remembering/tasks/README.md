...
| 2 | T4 | `PreCompact` recall injection | **None** — the recall already happened |
...
|----|-------|--------|--------|------------|
| T1 | Count recall-before-assertion from a session transcript | pending | F-1, F-2, F-4, F-5, F-15, F-16, F-17, UC1-S1, UC1-S2, UC1-S3 | `go vet ./clients/claude-code/ && go test ./clients/claude-code/ -run "TestF1\|TestF2\|TestF4\|TestF5\|TestF15\|TestF16\|TestF17\|TestTheInstrumentIsCalledByTheHook" -count=1 -v` |
