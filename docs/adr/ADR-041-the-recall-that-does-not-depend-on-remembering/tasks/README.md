...
| T4 | Perform the recall at compaction and inject the result | pending | F-6 | `go test ./clients/claude-code/ -run "^(TestF6AHookIsSilentInTheCommonCase\|TestPreCompactHookIsRegistered)$" -count=1 -v` |
