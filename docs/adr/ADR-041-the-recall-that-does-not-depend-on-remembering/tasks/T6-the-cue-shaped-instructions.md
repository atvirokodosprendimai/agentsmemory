...
- 2026-08-28 · human-observed · measurement window OPENED 2026-08-28: T6 live and verified on the running server (handshake returns 1194 bytes carrying the cue, not the imperative). Before-state re-taken with the shipped binary: 7.6% (26/341) over 24 sessions, classifier v3 — identical to the baseline, as it must be, since every transcript on disk predates T6. delta blocked until real sessions accumulate under the new handshake; F-10 records it whichever way it falls.
