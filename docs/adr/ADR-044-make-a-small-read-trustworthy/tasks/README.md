...
| T6 | Guarantee a caller never joins chunks, and take the tag off | pending | F-4, UC1-S3 | `go test ./internal/mcpserver/ -run 'TestF4ChunkingCreatesNoReassemblyObligation' …` |
